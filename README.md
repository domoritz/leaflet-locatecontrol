...
| `setView` | `boolean`  or `string`  | Set the map view (zoom and pan) to the user's location as it updates. Options are `false`, `'once'`, `'always'`, `'untilPan'`, or [`'untilPanOrZoom'`](https://github.com/domoritz/leaflet-locatecontrol/issues/213) | `'untilPanOrZoom'` |
